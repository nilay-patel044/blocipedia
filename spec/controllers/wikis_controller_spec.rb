...
RSpec.describe WikisController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "increases the number of Wikis by 1" do
      expect{ post :create, params: { wiki: { title: Faker::HowIMetYourMother.quote, body: Faker::TheFreshPrinceOfBelAir.quote, user: my_user } } }.to change(Wiki, :count).by(1)
    end
  ...
  describe "PUT update" do
    it "updates wiki with expected attributes" do
      new_title = Faker::HowIMetYourMother.quote
      new_body = Faker::TheFreshPrinceOfBelAir.quote
